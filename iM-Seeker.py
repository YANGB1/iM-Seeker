...
def main():
    ...
    parser.add_argument("--representative_conformation", help="Set the output of representative conformation (1 for average, 2 for shorter side loop), default=2", type=int)
    ...
    classification_model = pickle.load(open("pickle_model_final_classification.pkl", 'rb'))
    regression_model = pickle.load(open("pickle_model_final_regression.pkl", 'rb'))
